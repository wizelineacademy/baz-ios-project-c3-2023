...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let homeView = MainRouter.createModule()
        homeView.tabBarItem.image = UIImage(systemName: "house.fill")
        
        let favoriteMovieView = FavoriteMovieRouter.createModule()
        favoriteMovieView.tabBarItem.image = UIImage(systemName: "heart.fill")
        favoriteMovieView.title = "Favorite"
