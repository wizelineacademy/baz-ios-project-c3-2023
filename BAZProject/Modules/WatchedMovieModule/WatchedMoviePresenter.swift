...
extension WatchedMoviePresenter: WatchedMoviePresenterProtocols {
    ...
    public func getWatchedMovies() {
        interactor?.setIdMovies()
        interactor?.getWatchedMovies(from: .movie)
...
extension WatchedMoviePresenter: UITableViewDataSource {
...
extension WatchedMoviePresenter: UITableViewDelegate {
